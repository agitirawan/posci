                        ...
                        <tbody>
                            ...
                            foreach ($Transaksi as $Transaksi) { ?>
                                <tr>
                                    ...
                                    <td><?= $Transaksi['qty'] ?></td>
                                    <td><img src="<?php echo base_url() . '/gambar/' . $Transaksi['gambar'] ?>" style="width:200px"></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="total_bayar" name="total_bayar" required>
                </div>
                <div class="form-group">
