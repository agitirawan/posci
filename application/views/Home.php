...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assest/css/aos.css">

    <link rel="stylesheet" href="<?= base_url() ?>assest/css/ionicons.min.css">

    <link rel="stylesheet" href="<?= base_url() ?>assest/css/bootstrap-datepicker.css">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <h6 class="collapse-header">Ketegori</h6>
                                <a class="dropdown-item" href="<?= base_url('makanan') ?>">Makanan</a>
                                <a class="dropdown-item" href="<?= base_url('minuman') ?>">Minuman</a>
