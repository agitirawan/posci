...
<body>
    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <h1 class="fw-bold text-primary m-0">wa<span class="text-secondary">ru</span>ng</h1>
            </>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="<?= base_url() ?>user/menu" class="nav-item nav-link">Menu</a>
                    <a href="<?= base_url() ?>user/shoppingcart" class="nav-item nav-link">Shopping Cart</a>
                    <a href="<?= base_url() ?>user/logout" class="nav-item nav-link">Log out</a>
