...
<head>
    ...
    <link href="<?php base_url() ?>assets/kasir/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
</head>
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php base_url('kasir/ordermenu') ?>">Order Menu</a>>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTable" class="collapse show" aria-labelledby="headingTable" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?php base_url() ?>kasir/ordermenu">Order Menu</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
    ...
    <!-- Page level plugins -->
    <script src="<?php base_url() ?>assets/kasir/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="<?php base_url() ?>assets/kasir/vendor/datatables/dataTables.bootstrap4.min.js"></script>
